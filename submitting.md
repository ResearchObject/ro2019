...
[![gdoc-html](/assets/imggdoc-html.png)](/assets/imggdoc-html.png)
...
[![Upload to Zenodo](/assets/imgzenodo-00-ro-upload.png)](/assets/imgzenodo-00-ro-upload.png)
Now upload both the HTML and PDF version of your article:
[![zenodo-02-upload](/assets/imgzenodo-02-upload.png)](/assets/imgzenodo-02-upload.png)
...
![Start Upload](/assets/imgzenodo-09-start-upload.png)
...
[![Save](/assets/imgzenodo-10-save-then-publish.png)](/assets/imgzenodo-10-save-then-publish.png)
...
[![zenodo-03-info](/assets/imgzenodo-03-info.png)](/assets/imgzenodo-03-info.png)
...
[![zenodo-04-notes-and-license](/assets/imgzenodo-04-notes-and-license.png)](/assets/imgzenodo-04-notes-and-license.png)
...
[![zenodo-06-funding](/assets/imgzenodo-06-funding.png)](/assets/imgzenodo-06-funding.png)
...
[![zenodo-07-related-identifiers](/assets/imgzenodo-07-related-identifiers.png)](/assets/imgzenodo-07-related-identifiers.png)
Finally, click Save followed by Publish:
[![Save](/assets/imgzenodo-10-save-then-publish.png)](/assets/imgzenodo-10-save-then-publish.png)
You will need to confirm that your upload is final:
[![zenodo-12-confirm](/assets/imgzenodo-12-confirm.png)](/assets/imgzenodo-12-confirm.png)
Now your preprint is uploaded to Zenodo:
[![zenodo-12-ready](/assets/imgzenodo-12-ready.png)](/assets/imgzenodo-12-ready.png)
...
[![easychair-01-author](/assets/imgeasychair-01-author.png)](/assets/imgeasychair-01-author.png)
...
[![easychair-03-no-abstract](/assets/imgeasychair-03-no-abstract.png)](/assets/imgeasychair-03-no-abstract.png)
...
[![easychair-04-category](/assets/imgeasychair-04-category.png)](/assets/imgeasychair-04-category.png)
...
[![easychair-05-submit](/assets/imgeasychair-05-submit.png)](/assets/imgeasychair-05-submit.png)
