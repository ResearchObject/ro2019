...
* **2019-08-05** ~~2019-07-29~~ Camera-ready papers due for accepted articles
...
She co-established the [myExperiment.org](https://doi.org/10.1093/nar/gkq429) workflow repository and the [FAIRDOMHub.org](https://doi.org/10.1093/nar/gkw1032) for systems biology asset sharing. She is the co-lead of the interoperability platform for [ELIXIR](https://www.elixir-europe.org/), the EU Research Infrastructure for Life Sciences,  Head of Node of ELIXIR-UK and co-founder of the UK's Software Sustainability Institute. She has keynoted twice for IEEE e-Science (2005, 2012). In 2008 she was honoured by Microsoft Jim Gray award for outstanding contributions to eScience.
...
Currently, Raul is leading PSNC activities in [EVER-EST](http://ever-est.eu/) project, where Research Objects and ROHub have been used as the cornerstone to build a Virtual Research Environment for Earth Sciences. An ACM member and former MAE-AECI scholarship holder, Raul holds a Ph.D. in Computer Science and Artificial Intelligence (cum laude) and regularly publishes and reviews for top scientific conferences and journals in the area.
...
Daniel is a researcher at the [Information Sciences Institute](http://isi.edu/) of the [University of Southern California](http://www.usc.edu/) and along term collaborator with the [Ontology Engineering Group](http://www.oeg-upm.net/) at the [Artificial Intelligence Department](http://www.dia.fi.upm.es/) of the Computer Science Faculty of [Universidad Politécnica de Madrid](http://www.upm.es/institucional). 

His research activities focus on [e-Science](http://dbpedia.org/resource/E-Science) and the [Semantic Web](http://semanticweb.org/wiki/Category:Topic_Semantic_Web), specifically on how to increase the understandability of [scientific workflows](http://en.wikipedia.org/wiki/Scientific_workflow_system) using their [provenance](http://www.w3.org/2005/Incubator/prov/wiki/What_Is_Provenance) (i.e., steps, outputs, inputs, intermediate results) and exposing them as [Linked Data](http://www.w3.org/DesignIssues/LinkedData.html).  

Daniel has participated in [standardization efforts](http://www.w3.org/TR/prov-o/) and collaborated with different researchers throughout his career, which have led to significant contributions to my PhD work. He has been involved in the development of the Research Object model and its ontologies since the concepts inception in the EU project Wf4ever.
...
*   [Frederik Coppens](https://orcid.org/0000-0001-6565-5145) (VIB, Belgium)
*   [Oscar Corcho](https://orcid.org/0000-0002-9260-0753) (Universidad Politécnica de Madrid, Spain)
*   [David De Roure](https://orcid.org/0000-0001-9074-3016) (University of Oxford and Alan Turing Institute, UK)
*   [José Manuel Gómez Pérez](https://orcid.org/0000-0002-5491-6431) (expertsystem.com, Spain)
*   [Farah Zaib Khan](https://orcid.org/0000-0002-6337-3037) (The University of Melbourne, Australia)
*   [David Koop](https://orcid.org/0000-0002-4422-6162) (University of Massachusetts Dartmouth, USA)
*   [Dimitris Koureas](https://orcid.org/0000-0002-4842-6487) (Naturalis, NL)
*   [Paolo Manghi](https://orcid.org/0000-0001-7291-3210) (Open AIRE and CNR, Pisa Italy)
*   [Raja Mazumder](https://orcid.org/0000-0001-8823-9945) (BioComputeObjects, George Washington University, USA)
*   [James Myers](https://orcid.org/0000-0001-8462-650X) (SEAD project, University of Michigan, USA)
*   [Denis Parfenov](https://keybase.io/prfnv) (open knowledge, Ireland)
*   [Peter Sefton](https://orcid.org/0000-0002-3545-944X) (University of Technology Sydney, Australia)
*   [Anita de Waard](https://orcid.org/0000-0002-9034-4119) (Elsevier)
